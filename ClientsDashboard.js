    ...
    try {
      const reqObj = {
        ...
        mobileNumber: formInitialValues?.mobileNumber
          ...
          : "",
        clientId: formInitialValues?.clientId ? formInitialValues.clientId : "",
    ...
    <div>
          ...
          >
            ...
            <Container>
              ...
              >
                ...
                <div>
                  <Tooltip title="Check Claim Status">
                    <Button
                      variant="contained"
                      sx={{
                        mt: 3,
                      ...
                      onClick={() => {
                        history.push({
                          pathname: constant.PATH_GROUP_OPS_CLAIM_STATUS,
                          state: {
                            policyList: memoizedPolicyNumbers,
                          },
                        });
                      }}
                    >
                  ...
                  {roleType === constant.USERROLE_CLAIMS ||
                  roleType === constant.USERROLE_UW ? null : (
                    <Tooltip title="Renewal Details Download">
                      <Button
                        variant="contained"
                        sx={{
                          mt: 3,
                          ...
                          cursor: "pointer",
                          background:
                            "linear-gradient(to top, #f26221, #f5851f)",
                        }}
                        onClick={() => {
      ...
      <Container maxWidth={"xl"}>
        ...
        >
          ...
          />
          {/* <Snackbar message={"hiiiii"} isOpen={true} purpose={"success"} /> */}
        </Paper>
        ...
        {renewalModalOpen && (
          <RenewalModal
            ...
            openHandler={renewalModalHandler}
            formInitialValues={renewalValues}
            submitClickHandler={renewalClickHandler}
            isCommissionRequest={isCommissionRequest}
            setIsCommissionRequest={setIsCommissionRequest}
          />
        )}
      </Container>
